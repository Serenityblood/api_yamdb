...
cur.executemany("INSERT INTO titles_category (id, name, slug) VALUES (?, ?, ?);", to_db)
con.commit()
con.close()
...
cur.executemany("INSERT INTO titles_title_genre (id, title_id, genre_id) VALUES (?, ?, ?);", to_db)
con.commit()
con.close()
...
cur.executemany("INSERT INTO titles_genre (id, name, slug) VALUES (?, ?, ?);", to_db)
con.commit()
con.close()
...
cur.executemany("INSERT INTO titles_title (id, name, year, category_id) VALUES (?, ?, ?, ?);", to_db)
con.commit()
con.close()
